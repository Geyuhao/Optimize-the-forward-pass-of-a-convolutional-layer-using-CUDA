...
__global__ void conv_forward_kernel(int tile_size, float *y, const float *x, const float *k, const int B, const int M, const int C, const int H, const int W, const int K)
{
...
__host__ void GPUInterface::conv_forward_gpu(float *device_y, const float *device_x, const float *device_k, const int B, const int M, const int C, const int H, const int W, const int K)
{
    ...
    dim3 gridDim(B,M,Z);
    conv_forward_kernel<<<gridDim,blockDim>>>(tile_size,device_y,device_x,device_k,B,M,C,H,W,K);
}
